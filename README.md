...
The project includes a lightweight browser interface and JSON API. It does not
require an additional web framework. For local testing with Python 3.10–3.14,
install the reduced CPU-only dependency set:
...
The API accepts `POST /api/analyze` with a JSON body such as:
